...
from app.api.v1 import vpn, scheduled_reports, firmware_api, provisioning, syslog
...
router.include_router(vpn.router,                prefix="/vpn",                tags=["vpn"])
router.include_router(scheduled_reports.router,  prefix="/scheduled-reports",  tags=["scheduled-reports"])
router.include_router(firmware_api.router,       prefix="/firmware",           tags=["firmware"])
router.include_router(provisioning.router,       prefix="/devices",            tags=["provisioning"])
router.include_router(syslog.router,             prefix="/syslog",             tags=["syslog"])
